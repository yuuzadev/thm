...
这是我的 [MD2PDF](https://tryhackme.com/room/md2pdf) 房间的 Write-up。

# 概述

目标是利用一个将文本转换为 PDF 的 Web 应用程序来访问包含 flag 的页面。
...
This is my write-up for the [MD2PDF](https://tryhackme.com/room/md2pdf) room. 

# Overview

The goal was to exploit a web application that converts text to PDF to access a page with flag.
